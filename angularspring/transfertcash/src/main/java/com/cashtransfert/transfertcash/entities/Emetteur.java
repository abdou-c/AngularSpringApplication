...
public class Emetteur {
    ...
    public Emetteur(int id, String nom, String prenom, String telephone, int cni, List<DetailEnvoie> detailEnvoieList) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
    ...
    public Emetteur(int id, String nom, String prenom, String telephone, int cni) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.telephone = telephone;
